...
function MetaIcon() {
  return (
    <svg viewBox="0 0 48 48" className="w-5 h-5" fill="none">
      <rect width="48" height="48" rx="12" fill="#0064E0" />
      <path d="M16 16c0-1.1.9-2 2-2h12c1.1 0 2 .9 2 2v16c0 1.1-.9 2-2 2H18c-1.1 0-2-.9-2-2V16z" fill="#fff" fillOpacity="0.3" />
      <path fill="#fff" d="M18 18h4v12h-4z" />
      <path fill="#fff" d="M26 18h4v12h-4z" fillOpacity="0.6" />
